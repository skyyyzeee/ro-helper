...
- **Закреплённые карточки** — статьи и итог калькулятора остаются на экране поверх игры, а клики проходят сквозь них. Карточек может быть сколько угодно: каждая перетаскивается за свою шапку и растягивается за уголок, а если перетащить одну на другую — они соединяются в один блок. Закреплённые статьи возвращаются после перезапуска.
